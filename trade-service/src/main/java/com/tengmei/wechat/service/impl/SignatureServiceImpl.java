...
import com.tengmei.wechat.util.MD5;

@Service
public class SignatureServiceImpl implements SignatureService {
	private static final Logger logger = LoggerFactory.getLogger(SignatureServiceImpl.class);
	@Value("${wechat.payment.key}")
	private String key;

	/* (non-Javadoc)
	 * @see com.tengmei.wechat.service.impl.SignatureService#getSign(java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.tengmei.wechat.service.impl.SignatureService#getSign(java.util.Map)
	 */
	@Override
	...
	public static String getSignJSSDK(Map<String, Object> map) {
		ArrayList<String> list = new ArrayList<String>();
		for (Map.Entry<String, Object> entry : map.entrySet()) {
			if (entry.getValue() != "") {
				list.add(entry.getKey() + "=" + entry.getValue() + "&");
