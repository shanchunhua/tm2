...
public class WXBizMsgCrypt {
	...
	public WXBizMsgCrypt(String token, String encodingAesKey, String appId) {
		if (encodingAesKey.length() != 43) {
			throw new AppException(new AesException(AesException.IllegalAesKey));
		}
	...
	public String decryptEncryptMsg(String msgSignature, String timeStamp, String nonce, String encryptedMsg) {
		try {
			// 密钥，公众账号的app secret
			// 提取密文
			...
			// 解密
			String result = decrypt(encryptedMsg);
			return result;
		} catch (AesException e) {
			throw new AppException(e);
		}
